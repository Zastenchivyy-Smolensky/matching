...
export const signOut = () => {
  return client.delete("auth/sign_out", { headers: {
    "access-token": Cookies.get("_access_token")  as "access-token" ,
    "client": Cookies.get("_client") as "clinet" ,
    "uid": Cookies.get("_uid") as "uid"
  }})  
}
...
export const getCurrentUser = () => {
  ...
  return client.get("auth/sessions", { headers: {
    "access-token": Cookies.get("_access_token")  as "access-token" ,
    "client": Cookies.get("_client")  as "client" ,
    "uid": Cookies.get("_uid") as "uid"
  }})
}